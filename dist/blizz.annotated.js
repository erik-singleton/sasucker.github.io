...
.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('question', {
            url: '/question/:id',
            resolve: {
                question: ['$stateParams', 'questionModel', function($stateParams, questionModel) {
 ...
 * app.run I guess.
 */
.run(['$rootScope', '$timeout', '$location', '$window', 'SE', 'SEConfig', 'userConfig', function($rootScope, $timeout, $location, $window, SE, SEConfig, userConfig) {
    SE.init({
...
.directive('hljsSnippet', ['$timeout', '$interpolate', 'hljs', function($timeout, $interpolate, hljs) {
...
.directive('blizzsoExplore', ['$timeout', function($timeout) {
    function link(scope, ele, attr) {
